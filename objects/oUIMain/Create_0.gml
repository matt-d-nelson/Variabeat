...
tempoObject = instance_create_depth(indent + sprite_get_width(sLabel) + 4,24, depth-1,oTempo);
tempoVarObject = instance_create_depth(indent + 22,36, depth-1,oTempoVar);
...
saveLoadObject = instance_create_depth(indent,12,depth-1,oSaveLoad);
